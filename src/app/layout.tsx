...
export const metadata: Metadata = {
  ...
  description: "Software Engineer at Mayon Capital. Building web solutions and graphic art. Based in Pangasinan, Philippines.",
  keywords: ["Joshua Verceles", "jshmslf", "Software Engineer", "Full Stack Developer", "Next.js", "TypeScript", "Python", "Pangasinan", "Philippines", "Web Developer", "Graphic Artist"],
  ...
  twitter: {
    ...
    title: "Joshua Verceles - Software Engineer",
    description: "Software Engineer at Mayon Capital. Building web solutions and graphic art.",
    creator: "@jshmslf",
    images: ["/og.png"],
  },
  robots: {
